...
const PowerDistributor7Svg = ({width = 306}) => {

  return <svg width={width} height={width * 0.193} viewBox="0 0 306 59" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="0.25" y="0.25" width="305.5" height="58.5" rx="19.75" fill="url(#paint7_linear)" stroke="black"
          stroke-width="0.5"/>
    ...
    <circle cx="216" cy="30.3846" r="15.1346" fill="white" stroke="black" stroke-width="0.5"/>
    <circle cx="216" cy="26.5387" r="2.3141" fill="white" stroke="black" stroke-width="0.5"/>
    <circle cx="216" cy="34.2311" r="2.3141" fill="white" stroke="black" stroke-width="0.5"/>
    ...
    <circle cx="253" cy="30.3846" r="15.1346" fill="white" stroke="black" stroke-width="0.5"/>
    <circle cx="253" cy="26.5387" r="2.3141" fill="white" stroke="black" stroke-width="0.5"/>
    <circle cx="253" cy="34.2311" r="2.3141" fill="white" stroke="black" stroke-width="0.5"/>
    ...
    <rect x="280.25" y="24.25" width="6.5" height="14.5" fill="white" stroke="black" stroke-width="0.5"/>
    <defs>
      <linearGradient id="paint7_linear" x1="153" y1="0" x2="153" y2="59" gradientUnits="userSpaceOnUse">
...
PowerDistributor7Svg.propTypes = {
  width: PropTypes.number
}

export default memo(PowerDistributor7Svg);
